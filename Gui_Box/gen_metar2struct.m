function [ metarStruct ] = gen_metar2struct( metarfilepath, ...
    savefilepath, metartype, minuteinterval )
...
if metartype == 4 % SBU HSC MET Data
    ...
    % (15), THSW index (16), Pressure Hg (17), Rain in day (18), Rain rate
    % (19), etc.
    dataSBU = textscan(fid, ['%s %s %s %s %s %s %s %s %s %s %s %s %s %s' ...
    ...
    dataSBU = {dataSBU{1:2}, dataSBU{4:end}};
    ...
    % the metarStruct
    for i = 1:length(dataSBU{1})
        date = datenum([dataSBU{1}{i} ' ' dataSBU{2}{i}], 'mm/dd/yy HH:MM');
        metarStruct(i).date = date;
        metarStruct(i).temp = (5/9) * (str2double(dataSBU{3}{i}) - 32); % Convert to deg. C
        metarStruct(i).maxtemp = (5/9) * (str2double(dataSBU{4}{i}) - 32);
        metarStruct(i).mintemp = (5/9) * (str2double(dataSBU{5}{i}) - 32);
        metarStruct(i).relhum = str2double(dataSBU{6}{i});
        metarStruct(i).dewpt = (5/9) * (str2double(dataSBU{7}{i}) - 32);
        metarStruct(i).wspd = str2double(dataSBU{8}{i}) * 0.44704; % Convert mph to m/s
        if strcmp(dataSBU{9}{i}, '---')
            metarStruct(i).wdir = NaN;
        else
            ...
            if strcmp(dataSBU{9}{i}, 'WNW')
                metarStruct(i).wdir = 292.5;
            elseif strcmp(dataSBU{9}{i}, 'W')
                metarStruct(i).wdir = 270;
            elseif strcmp(dataSBU{9}{i}, 'NW')
                metarStruct(i).wdir = 315;
            elseif strcmp(dataSBU{9}{i}, 'NE')
                metarStruct(i).wdir = 45;
            elseif strcmp(dataSBU{9}{i}, 'SSE')
                metarStruct(i).wdir = 157.5;
            elseif strcmp(dataSBU{9}{i}, 'WSW')
                metarStruct(i).wdir = 247.5;
            elseif strcmp(dataSBU{9}{i}, 'SW')
                metarStruct(i).wdir = 225;
            elseif strcmp(dataSBU{9}{i}, 'SSW')
                metarStruct(i).wdir = 202.5;
            elseif strcmp(dataSBU{9}{i}, 'NNW')
                metarStruct(i).wdir = 337.5;
            elseif strcmp(dataSBU{9}{i}, 'NNE')
                metarStruct(i).wdir = 22.5;
            elseif strcmp(dataSBU{9}{i}, 'S')
                metarStruct(i).wdir = 180;
            elseif strcmp(dataSBU{9}{i}, 'SE')
                metarStruct(i).wdir = 135;
            elseif strcmp(dataSBU{9}{i}, 'ENE')
                metarStruct(i).wdir = 67.5;
            elseif strcmp(dataSBU{9}{i}, 'E')
                metarStruct(i).wdir = 90;
            elseif strcmp(dataSBU{9}{i}, 'N')
                metarStruct(i).wdir = 0;
            elseif strcmp(dataSBU{9}{i}, 'ESE')
                metarStruct(i).wdir = 112.5;
            end
        end
        metarStruct(i).gust = str2double(dataSBU{11}{i}) * 0.44704;
        if strcmp(dataSBU{12}{i}, '---')
            ...
            %%% common occurence (based on 2014-15 Winter) is first. This
            %%% minimizes the amount of if-statements that must be executed
            if strcmp(dataSBU{12}{i}, 'WNW')
                metarStruct(i).gustdir = 292.5;
            elseif strcmp(dataSBU{12}{i}, 'W')
                metarStruct(i).gustdir = 270;
            elseif strcmp(dataSBU{12}{i}, 'NW')
                metarStruct(i).gustdir = 315;
            elseif strcmp(dataSBU{12}{i}, 'NE')
                metarStruct(i).gustdir = 45;
            elseif strcmp(dataSBU{12}{i}, 'SSE')
                metarStruct(i).gustdir = 157.5;
            elseif strcmp(dataSBU{12}{i}, 'WSW')
                metarStruct(i).gustdir = 247.5;
            elseif strcmp(dataSBU{12}{i}, 'SW')
                metarStruct(i).gustdir = 225;
            elseif strcmp(dataSBU{12}{i}, 'SSW')
                metarStruct(i).gustdir = 202.5;
            elseif strcmp(dataSBU{12}{i}, 'NNW')
                metarStruct(i).gustdir = 337.5;
            elseif strcmp(dataSBU{12}{i}, 'NNE')
                metarStruct(i).gustdir = 22.5;
            elseif strcmp(dataSBU{12}{i}, 'S')
                metarStruct(i).gustdir = 180;
            elseif strcmp(dataSBU{12}{i}, 'SE')
                metarStruct(i).gustdir = 135;
            elseif strcmp(dataSBU{12}{i}, 'ENE')
                metarStruct(i).gustdir = 67.5;
            elseif strcmp(dataSBU{12}{i}, 'E')
                metarStruct(i).gustdir = 90;
            elseif strcmp(dataSBU{12}{i}, 'N')
                metarStruct(i).gustdir = 0;
            elseif strcmp(dataSBU{12}{i}, 'ESE')
                metarStruct(i).gustdir = 112.5;
            end
        end
        metarStruct(i).pres = str2double(dataSBU{17}{i}) * 33.8639; % Convert Hg to mb
        metarStruct(i).precip01 = str2double(dataSBU{18}{i}) * 25.4; % Convert inches to mm
        metarStruct(i).rainrate = str2double(dataSBU{19}{i}) * 25.4; % Convert in/hr to mm/hr
...
if metartype == 3 % SBU L13 (South P Lot) MET Data
    ...
    for i = 1:length(dataSBU{1})
        ...
        metarStruct(i).pres = str2double(dataSBU{16}{i}) * 33.8639; % Convert Hg to mb
        metarStruct(i).precip01 = str2double(dataSBU{17}{i}) * 25.4; % Convert inches to mm
        metarStruct(i).rainrate = str2double(dataSBU{18}{i}) * 25.4; % Convert in/hr to mm/hr
